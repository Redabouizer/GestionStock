...
Produit::Produit(const std::string& ref, const std::string& des, int q, float prix, Stock* s, Fournisseur* f) :
        reference(ref), designation(des), quantite(q), prixHT(prix), stock(s), fournisseur(f) {}
